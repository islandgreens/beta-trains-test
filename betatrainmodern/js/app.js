...
// Maps the shared abstract platform key to this design's own CSS variables.
...
function renderEntryCard(entry, status) {
  ...
  const statusBadgeClass = status === "open-beta" ? "badge badge--status badge--filled" : "badge badge--status";
  ...
  return `
    <article class="entry-card">
      ...
      <div class="entry-card__badges">
        ...
        <span class="${statusBadgeClass}" style="--badge-color: var(${colorVar});">${STATUS_LABEL[status]}</span>
      </div>
